...
typedef         void    (_stdcall *TProcSR3N3)(const char *, double, double, double, int, int, int);    
typedef         void    (_stdcall *TProcS2)(const char *, const char *);    
typedef         void    (_stdcall *TProcS2N2)(const char *, const char *, int, int);      
typedef         void    (_stdcall *TProcS4NP)(const char *, const char *, const char *, const char *, int, void *);      
...
typedef         int     (_stdcall *TMsgBox)(int, const char *, const char *, int);        
...
inline void PT4TaskMakerLink::CreateGroup(      const char*             GroupName, 
                                                                        ...
                                                                        TInitTaskProc   InitTaskProc)
{
        creategroup_(GroupName , GroupDescription , GroupAuthor ,GroupKey , TaskCount, InitTaskProc);
...
void _stdcall activate(const char * DllName)
{
